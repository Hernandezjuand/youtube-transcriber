...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorMessage = data.error || data.message || 'Failed to transcribe video';
      ...
      try {
        ...
        if (!summaryResponse.ok) {
          const errorMessage = summaryData.error || 'Failed to generate summary';
        ...
        setError(err instanceof Error ? err.message : 'Failed to generate summary. You can still view the full transcript below.');
      } finally {
